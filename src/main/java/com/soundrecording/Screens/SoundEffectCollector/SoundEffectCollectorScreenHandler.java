...
public class SoundEffectCollectorScreenHandler extends ScreenHandler {
    ...
    public SoundEffectCollectorScreenHandler(int synvId, PlayerInventory playerInventory, BlockPos pos){
        this(synvId, playerInventory, playerInventory.player.getWorld().getBlockEntity(pos));
    }

    public SoundEffectCollectorScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity entity) {
        super(ModScreenHandler.SOUND_EFFECT_COLLECTOR_SCREEN_HANDLER_SCREEN_HANDLER, syncId);
